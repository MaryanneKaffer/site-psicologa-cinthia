...
export default function FeedBacks() {
    ...
    return (
        <section className="w-[100dvw] h-[100dvh] bg-white flex flex-col justify-center items-center gap-5 overflow-hidden ">
            <div className="sm:w-[80vw] h-full max-w-[85vw] mt-[100px]">
                ...
                <p className="lg:text-[18px] lgxl:text-[24px] lg:mt-5 lgxl:mt-[100px]">Todos os depoimentos são verdadeiros. Decidimos  manter nomes e avatares ficticios para preservar o sigilo</p>
            </div>
        </section>
    )
}