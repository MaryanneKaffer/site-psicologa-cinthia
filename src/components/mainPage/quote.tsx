...
export default function Quote() {
    ...
    useEffect(() => {
        if (window.scrollY > 1400) { setIsVisible(true) }
    })
    return (
        <section className="bg-[#667561] w-[100dvw] lg:h-[130dvh] h-[115dvh] text-white relative flex flex-col overflow-hidden sm:justify-center xl:px-[14vw] md:px-[12vw] px-4 cursor-default">
            {isVisible && (
