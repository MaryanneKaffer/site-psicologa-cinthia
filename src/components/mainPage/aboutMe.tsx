...
export default function AboutMe() {
    ...
    return (
        <section className="w-[100dvw] lg:h-[110dvh] h-[125dvh] lg:mt-0 mt-8 text-white sm:rounded-b-[100px] rounded-b-[50px] relative flex lg:justify-center lg:place-items-center relative">
            {isVisible && (
                <motion.div className="lg:gap-[80px] gap-[50px] flex" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: "easeOut" }}>
                    ...
                    <div className="flex flex-col gap-[4vh] cursor-default">
                        <h1 className="text-[5vh] xl:text-[6.5vh] font-ramillasItalic md:text-black tracking-tight lg:static absolute top-[38vh] right-5">
